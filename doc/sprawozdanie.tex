...
\end{figure}
Nachylenie (slope) w najlepszym praypadku może przyjąć wartość 1, ponieważ krzywa regresji 
...
\begin{figure}[pht]
 ...
 \caption{Wykres wartości slope}\label{rys:plot1}
\end{figure}
Optymalną wartością przesunięcia jest 0. Ponownie widać, że metoda momentum niewiele oddala się od
